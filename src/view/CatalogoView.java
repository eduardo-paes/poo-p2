...
public class CatalogoView extends JFrame {
	...
	private void salvarItem() {
		...
		if (txtDescricaoItem.getText().length() == 0 && cmbTipoItem.getSelectedIndex() == -1) {
			JOptionPane.showMessageDialog(null, "É necessário preencher o campo Descrição e Tipo do Item.");
			return;
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Preço precisa estar em formato numérico.");
		}
	...
	private void preenchimentoInicial() {
		...
		Object[] columnItem = { "Código", "Tipo", "Descri\u00E7\u00E3o", "Preço" };
